...
def get_plotly_timez_zip_series_url(x, y, z, filename):
    """
        This inputs data and spits out a scatter graph
        :param x: coordinates are datetimes
        :param y: coordinates are zipcodes
	:param z: coordinates are sentiments
    """
    data = Data([
                Scatter(
                         x=x,
                         y=y,
			 z=z,
                         name='Average Sentiment Value by Date and Zipcode',
                )
    ])
